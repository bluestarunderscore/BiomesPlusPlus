...
public class BppPlacedFeatures
{
    ...
    public static final ResourceKey<PlacedFeature> FANCY_OAK_CHANCEPER_KEY_PLACED = registerKey("fancy_oak_talloak");
    ...
    public static final ResourceKey<PlacedFeature> END_BUSH_KEY_PLACED = registerKey("end_bush");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context)
    {
        ...
        register(context, FANCY_OAK_CHANCEPER_KEY_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(BppConfiguredFeatures.FANCY_OAK_KEY),
        ...
        register(context, END_BUSH_KEY_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(BppConfiguredFeatures.END_BUSH_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(8, 0.01f, 1),(Blocks.OAK_SAPLING)));
        ...
        register(context, TINY_END_BUSH_KEY_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(BppConfiguredFeatures.TINY_END_BUSH_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(19, 0.01f, 1),(Blocks.OAK_SAPLING)));

        register(context, DARK_END_KEY_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(BppConfiguredFeatures.DARK_END_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(17, 0.01f, 1),(Blocks.OAK_SAPLING)));

        register(context, JUNGLE_END_KEY_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(BppConfiguredFeatures.JUNGLE_END_KEY),
        ...
        register(context, HUGE_CYAN_MUSHROOM_KEY_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(BppConfiguredFeatures.HUGE_CYAN_MUSHROOM_KEY),
                VegetationPlacements.treePlacement(RarityFilter.onAverageOnceEvery(4),(Blocks.BROWN_MUSHROOM)));
